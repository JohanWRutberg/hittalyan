...
export function ChanceMeter({
  ...
  return (
    <div className="flex items-center gap-2.5" title={
      hasRange
        ? `Liknande lägenheter har gått till sökande med ${q1}–${q3} års kötid${userYears != null ? `. Din kötid: ${formatYears(userYears)}` : ""}`
        : "Bostadsförmedlingen saknar statistik för den här annonsen"
    }>
